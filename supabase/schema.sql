...
create or replace function public.mark_profile_active()
returns void
language sql
security definer
set search_path = public
...
revoke all on function public.mark_profile_active() from public;
grant execute on function public.mark_profile_active() to authenticated;
